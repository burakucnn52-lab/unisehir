...
import { GraduationCap, Search, Clock, BookOpen } from 'lucide-react'
...
export default function Header() {
  ...
  useEffect(() => {
    // 2027 YKS Tarihi (Tahmini: 19 Haziran 2027 Cumartesi)
        ...
        <div className="container-custom">
          <div className="flex items-center justify-center gap-2 md:gap-4 text-sm flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">2027 YKS'ye:</span>
            </div>
            <div className="flex items-center gap-2 font-mono">
              <div className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-md min-w-[50px] text-center">
        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/bilgi-kartlari" className="text-gray-700 hover:text-primary-600 font-medium flex items-center gap-1">
